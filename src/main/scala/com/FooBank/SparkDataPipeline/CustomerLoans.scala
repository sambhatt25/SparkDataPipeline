...
object CustomerLoans {
  ...
  def createJsonDF(url: String)(implicit sparkCon: SparkSession)={
     /*
      This function is used to read JSON url and returns the dataframe generated
     */
  ...
  def createCsvDF (url: String, delim: String=",")(implicit sparkCon: SparkSession)={
    /*
      This function is used to read CSV url and returns the dataframe generated by downloading the content of the file
	  schema of the file is automatically generated by using header of the file
     */
  ...
  def getDataframeFromMultipleUrlCsv(urlList: List[String],delim:String=",",headerString:String) (implicit sparkCon: SparkSession) = {
     /*
      This function takes list of csv urls and dynamically creates a single dataframe, assumed all the file having same schema
     */
  ...
  def getObservationsDF(customerFileLoc: String, loanFilesLoc:List[String], visitsFileLoc: String)(implicit sparkCon: SparkSession) = {
   /*
     This is the dataframe operations function, where all the required dataframes are created and joined as per joining keys.
    ...
    //UDF created to clean the webvisit_id as it was not coming properly, extracting only the number part of it
  ...
  /*
  This function takes the dataframe and writes to the output file
  */
    df.coalesce(1)
...
/*
  Below three functions are to create handle the file operation as spark creates file in part files.
*/ 
...
def deleteRecursively(file: File): Unit = {
 ...
 def main(args: Array[String]) {
   ...
   //Getting the resultant DF by using all the URLs
   val observationsDF=getObservationsDF(customersFileUrl,loanFilesUrlList,visitsFileUrl)(spark)
   
   //This just prints the sample data in tabular visualization
   observationsDF.show()
   
   //Writting into the file
   dataFrameCsvWriter(observationsDF,"opFilePath_tmp")
   
   moveRenameFile(getListOfFiles("opFilePath_tmp")(0),opFilePath)
   
   deleteRecursively(new File("opFilePath_tmp"))
